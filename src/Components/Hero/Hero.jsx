...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col-reverse items-center justify-between gap-24 px-6 pb-24 pt-36 lg:flex-row">
        ...
        >
          ...
          <p className="mt-8 max-w-xl text-lg leading-9 text-slate-400">
            ...
            I build fast, scalable and production-ready web applications using the MERN Stack, focusing on clean architecture, exceptional user experience, and modern interfaces.

            I enjoy crafting modern interfaces with smooth
            animations while keeping backend architecture
      ...
      >
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="rounded-full border border-cyan-400/20 bg-cyan-400/10 p-3 text-cyan-400 backdrop-blur-xl">
            <HiArrowDown size={24} />
          </div>
